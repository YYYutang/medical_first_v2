  ...
  <div>
    ...
    <el-card class="user_list_card">
      ...
      >
        ...
        <el-table-column prop="createUser" label="用户名称"> </el-table-column>
        <el-table-column prop="classPath" label="所属类别" width="400">
        ...
        <el-table-column label="操作" width="200">
          <template slot-scope="scope">
            ...
            <el-badge
              :value="checkInfos(scope.row.checkApproving)"
              class="item"
              style="margin-left: 10px"
            >
              <el-button
                ...
                circle
                @click="getCheckDataById(scope.row.id, scope.row.tableName)"
              ></el-button>
            </el-badge>
          </template>
        </el-table-column>
    ...
    <el-dialog
      title="数据表下载审批"
      :visible.sync="checkAdminDataManageVisible"
      v-loading="multipleLoding"
    >
      <el-button
        type="primary"
        round
      ...
      >
      <el-button type="success" round @click="confirmUsenames(1)">
        <i class="el-icon-check"></i>一键同意</el-button
      >
      <el-button type="danger" round @click="confirmUsenames(0)">
      ...
      >
        ...
        <el-table-column prop="uid" label="用户id" width="120" align="center">
        </el-table-column>
        <el-table-column
          prop="username"
          label="用户名称"
        ...
        <el-table-column prop="classpath" label="所属类别" align="center">
        </el-table-column>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button
              type="success"
              round
              @click="updateCheckApprove(scope.row.username, 1)"
              >同意下载</el-button
            >
            ...
            <el-button
              type="danger"
              round
              @click="updateCheckApprove(scope.row.username, 0)"
              >拒绝下载</el-button
            >
          </template>
        </el-table-column>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="checkAdminDataManageVisible = false"
          >取 消</el-button
        >
        <el-button type="primary" @click="checkAdminDataManageVisible = false"
          >关 闭</el-button
        >
      </div>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    async getLevel3ById(pid, level) {
      ...
      console.log(
        "this.disOptions",
        this.disOptions.secondSelect,
        this.disOptions.thirdSelect
      );
    },
    ...
    getAllAdminDataTable() {
      getRequest(`/api/sysManage/selectAdminDataManage`).then((res) => {
        if (res.code == 200) {
          console.log("ret data", res.data);
    ...
    getAdminDataTableByName(type) {
      ...
      getRequest(`/api/sysManage/selectDataByName`, {
    ...
    upRequest(data) {
      ...
      this.options = {
        method: "post",
        data: payload,
        url: "/api/sysManage/uploadDataTable",
        headers: {
    ...
    deleteAdminDataManage(id, uid, tableId, tableSize, tableName) {
      ...
      getRequest(`/api/sysManage/deleteByTableName`, {
        id: id,
        uid: uid,
        tableId: tableId,
        tableSize: tableSize,
    ...
    getCheckDataById(id, tableName) {
      ...
      getRequest(`/api/sysManage/selectUsernamesById`, {
        id: id,
      }).then((res) => {
        if (res.code == 501) {
          // 自定义状态码
    ...
    updateCheckApprove(username, type) {
      getRequest(`/api/sysManage/updateCheckApprove`, {
        id: this.tid,
        username: username,
        type: type,
      }).then((res) => {
   ...
   confirmUsenames(type) {
    ...
    async confirmEditAdminDataManage() {
      ...
      console.log(
        "edit",
        this.adminDataManageForm.tableStatus,
