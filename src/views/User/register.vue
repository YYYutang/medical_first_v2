          ...
          <div class="registerContainer">
            ...
            <div class="myForm">
              ...
              >
                ...
                <el-form-item prop="answer1" label="安全密保答案一">
                  <el-input
                    type="text"
                    auto-complete="false"
                    v-model="registerForm.answer1"
                ...
                <el-form-item prop="answer2" label="安全密保答案一">
                  <el-input
                    type="text"
                    auto-complete="false"
                    v-model="registerForm.answer2"
                ...
                <el-form-item prop="answer3" label="安全密保答案三">
                  <el-input
                    type="text"
                    auto-complete="false"
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        answer3: [{ required: true, message: "请输入答案", trigger: "blur" }],
      },
      questionOptions: [
        {
          value: "1",
      ...
      this.$refs.registerForm.validate((valid) => {
        if (valid) {
          ...
          const params = {
            ...
            answer1:
              this.registerForm.question1 + ":" + this.registerForm.answer1,
            answer2:
              this.registerForm.question2 + ":" + this.registerForm.answer2,
            answer3:
              this.registerForm.question3 + ":" + this.registerForm.answer3,
            role: 1,
            userStatus: 0,
          };
