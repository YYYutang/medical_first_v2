    ...
    <div class="left_tree">
      ...
      <el-dialog
          ...
          <div class="addDataClass">
              <i style="margin-left: 10px" class="el-icon-s-data"></i>&nbsp;&nbsp;&nbsp;数据集名称：<el-input v-model="addDataForm.dataName" placeholder="请输入数据集名称"></el-input>
              <span class="addDataBaseInfo">
                <i class="el-icon-user-solid"></i>&nbsp;&nbsp;&nbsp;创建人：<el-input v-model="addDataForm.createUser" placeholder="请输入创建人姓名"></el-input>
              </span>
              <span class="addDataBaseInfo">
                <i class="el-icon-time"></i>&nbsp;&nbsp;&nbsp;创建时间：<span>{{ showDataForm.createTime }}</span>
              </span>
              <span class="addDataBaseInfo">
                <i class="el-icon-pie-chart"></i>&nbsp;&nbsp;&nbsp;所属类别：<span>{{ showDataForm.classPath }}</span>
             </span>
          </div>
