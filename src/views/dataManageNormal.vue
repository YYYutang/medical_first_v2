  ...
  <div class="content">
    ...
    <el-dialog title="新增数据集" :visible.sync="dialogDataVisible" width="1150px">
      ...
      <div class="addDataClass" style="margin-top: 20px">
        ...
        <!-- 显示筛选出来的表数据 -->
        <el-table :data="addTableData" stripe style="width: 100%" max-height="450" v-show="showAddTableData"
...
export default {
  ...
  methods: {
    ...
    upRequest(data) {
      ...
      payload.append("size", this.$refs["uploadRef"].uploadFiles[0].size / 100000);
