        ...
        <div class="addDataClass" style="margin-top: 20px">
          ...
          >
            ...
            <span v-else>
              ...
              <el-button
                disabled
                style="width: 115px; background-color: #f5f7fa"
          ...
          <el-container>
            <el-aside width="180px">
              <el-menu default-active="1" class="el-menu-vertical-demo">
                ...
                <el-menu-item index="2" @click="exchangeCharacterList(2)">
  ...
  methods: {
    ...
    changeData(data) {
      if (data.isLeafs == 1) {
        ...
        this.$emit("send_tableName", data.label);
      }
    },
    append(isLeaf) {
      // 发送请求新增一个病种信息（目录结构）
